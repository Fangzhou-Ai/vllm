...
from vllm._atom.model_ops.linear import use_triton_gemm
from vllm._atom.model_ops.utils import get_and_maybe_dequant_weights
...
if is_rocm_aiter_fp4bmm_enabled():
    ...
    from vllm._atom.model_ops.utils import quark_post_load_weights
...
class MLAAttention(nn.Module):
    ...
    def _forward_prefill_cached_chunked(
        ...
        """
        from vllm._atom.model_ops.attentions.triton_merge_attn_states import merge_attn_states
