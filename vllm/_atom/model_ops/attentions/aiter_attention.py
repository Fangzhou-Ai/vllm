...
from vllm._atom.utils.block_convert import kv_indices_generate_triton
from vllm._atom.model_ops.attention_mha import PagedAttentionImpl
from vllm._atom.utils.forward_context import AttentionMetaData, Context
from vllm._atom.utils.tbo import TokenSplitPrefillState
...
class AiterAttentionMetadataBuilder(CommonAttentionBuilder):
    ...
    def __init__(
        ...
        from vllm._atom.utils import envs as _envs
    ...
    def build_kv_cache_tensor(self, layer_id: int, module):
        ...
        """
        from vllm._atom.config import KVCacheTensor
        from aiter import dtypes
    ...
    def _attach_tbo_token_split_straddle_prefix(self, ub_attn, ub_slice):
        ...
        from vllm._atom.utils.tbo import compute_straddle_split_info
