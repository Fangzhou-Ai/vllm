...
from vllm._atom.model_ops.attentions.backends import (
    AttentionBackend,
...
class DeepseekV4AttentionMetadataBuilder(CommonAttentionBuilder):
    ...
    def build_kv_cache_tensor(self, layer_id: int, module):
        ...
        from vllm._atom.models.deepseek_v4 import Compressor as _V4Compressor
        from vllm._atom.models.deepseek_v4 import DeepseekV4Attention as _V4Attention
        from vllm._atom.models.deepseek_v4 import Indexer as _V4Indexer
    ...
    def build_ubatch_prefill_metadata(
        ...
        from vllm._atom.utils.tbo.ubatch_splitting import split_attn_metadata
