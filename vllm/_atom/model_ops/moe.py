...
from vllm._atom.config import (
    Config,
    QuantizationConfig,
    get_current_atom_config,
)
from vllm._atom.model_loader.weight_utils import set_weight_attrs
from vllm._atom.model_ops.base_config import QuantizeMethodBase
from vllm._atom.model_ops.fused_moe.config import (
...
from vllm._atom.model_ops.fused_moe.modular_kernel import (
    FusedMoEModularKernel,
    FusedMoEPrepareAndFinalize,
)
from vllm._atom.model_ops.fused_moe.mori_prepare_finalize import MoriPrepareAndFinalize
from vllm._atom.model_ops.topK import (
    init_aiter_topK_meta_data,
    is_rocm_aiter_fuse_routed_scaling_factor,
    is_rocm_aiter_fusion_shared_expert_enabled_for_quant_config,
)
from vllm._atom.model_ops.topK import rocm_aiter_grouped_topk as grouped_topk
from vllm._atom.model_ops.topK import rocm_aiter_topk_softmax as fused_topk
from vllm._atom.model_ops.utils import (
    _has_module,
    atom_parameter,
...
from vllm._atom.plugin.vllm.moe import FusedMoEDecoratorForPluginMode
from vllm._atom.quant_spec import LayerQuantConfig, should_skip_online_quant
from vllm._atom.quantization.quark.utils import weight_dequant_fp8
from vllm._atom.utils import envs
from vllm._atom.utils.custom_register import direct_register_custom_op
from vllm._atom.utils.decorators import mark_trace
from vllm._atom.utils.forward_context import get_forward_context
...
class FusedMoEMethodBase(QuantizeMethodBase):
    ...
    def _maybe_make_prepare_finalize(
        ...
        if moe.use_mori_kernels:
            ...
            from vllm._atom.config import get_current_atom_config
            from vllm._atom.utils.tbo.ubatching import tbo_enabled
            ...
            if is_async:
                from vllm._atom.model_ops.fused_moe.mori_prepare_finalize import (
                    _NUM_TBO_UBATCHES,
                    init_mori_op,
                )
...
class Mxfp4MoEMethod(FusedMoEMethodBase):
    ...
    def process_weights_after_loading(self, layer):
        ...
        if self.use_triton:
            from vllm._atom.config import get_current_atom_config
            from vllm._atom.model_ops.fused_moe_triton import _swizzle_mxfp4
    ...
    def apply(
        ...
        if self.use_triton:
            from vllm._atom.model_ops.fused_moe_triton import (
...
class CompressedTensorsFp8MoEMethod(FusedMoEMethodBase):
    ...
    def get_fused_moe_quant_config(
        ...
        from vllm._atom.model_ops.fused_moe.config import fp8_w8a8_moe_quant_config
...
class FusedMoE(torch.nn.Module):
    ...
    def select_experts(
        ...
        if use_grouped_topk:
            ...
            if scoring_func == "softmax":
                ...
                if fuse_shared:
                    import vllm._atom.model_ops.topK as _topK_mod
    ...
    def forward_impl_graph(
        ...
        if use_dp_gather_scatter:
            ...
            from vllm._atom.utils.tbo.ubatching import tbo_active

            _tbo = tbo_active()
            if _tbo:
                from vllm._atom.utils.tbo.ubatching import (
