...
import vllm._atom.model_ops.fused_moe.modular_kernel as mk
from vllm._atom.model_ops.fused_moe.config import FusedMoEQuantConfig
...
class MoriPrepareAndFinalize(mk.FusedMoEPrepareAndFinalize):
    ...
    def _prepare_async_ll(
        ...
        from vllm._atom.utils.tbo.ubatching import tbo_current_ubatch_id
