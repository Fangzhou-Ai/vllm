...
from vllm._atom.config import CompilationConfig, Config, CUDAGraphMode
...
def get_static_graph_wrapper_cls(cls) -> str:
    return "vllm._atom.utils.cuda_graph.CUDAGraphWrapper"
...
class CompilerManager:
    ...
    def compile(
        ...
        try:
            from vllm._atom.utils.graph_marker import is_graph_marker_enabled
...
class VllmBackend:
    ...
    def __call__(self, graph: fx.GraphModule, example_inputs) -> Callable:
        ...
        from vllm._atom.utils.decorators import torch_compile_start_time
