...
class KVConnectorFactory:
    ...
    Usage::
        ...
        KVConnectorFactory.register(
            "moriio",
            worker_module="vllm._atom.kv_transfer.disaggregation.moriio.moriio_connector",
            worker_class="MoRIIOConnector",
            scheduler_module="vllm._atom.kv_transfer.disaggregation.moriio.moriio_connector",
...
KVConnectorFactory.register(
    "mooncake",
    worker_module="vllm._atom.kv_transfer.disaggregation.mooncake.mooncake_connector",
    worker_class="MooncakeConnector",
    scheduler_module="vllm._atom.kv_transfer.disaggregation.mooncake.mooncake_connector",
