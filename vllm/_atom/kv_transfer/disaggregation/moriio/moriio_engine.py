...
from vllm._atom.kv_transfer.disaggregation.types import RemoteAllocInfo
from vllm._atom.utils import make_zmq_path, make_zmq_socket
...
class MoRIIOWrapper:
    ...
    def async_wait_reqid(self):
        ...
        def _async_wait():
            from vllm._atom.kv_transfer.disaggregation.moriio.moriio_connector import (
                _zmq_ctx,
            )
