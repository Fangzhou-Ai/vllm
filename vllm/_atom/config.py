...
from vllm._atom.quant_spec import (
    LayerQuantConfig,
    get_quant_parser,
)
from vllm._atom.utils import envs, get_open_port
from vllm._atom.utils.distributed.utils import stateless_init_torch_distributed_process_group
from torch.distributed import ProcessGroup, ReduceOp
from transformers import AutoConfig, GenerationConfig, PretrainedConfig

# plugin-related utilities
from vllm._atom.plugin import is_plugin_mode, is_vllm
from vllm._atom.plugin.config import PluginConfig
...
def _normalize_moe_config_fields(
    ...
    if existing_n_shared is not None:
        ...
        from vllm._atom.models.utils import ckpt_shared_expert_count
...
class Config:
    ...
    runner_qualname: str = "vllm._atom.model_engine.model_runner.ModelRunner"
