...
if TYPE_CHECKING:
    from vllm._atom.model_ops.attentions.deepseek_v4_attn import AttentionMetaData_DSV4
...
from vllm._atom.model_loader.loader import WeightsMapper
...
from vllm._atom.model_ops import module_dispatch_ops as _module_dispatch_ops  # noqa: F401
from vllm._atom.model_ops.embed_head import ParallelLMHead, VocabParallelEmbedding
from vllm._atom.model_ops.layernorm import RMSNorm, rmsnorm2d_fwd_
from vllm._atom.model_ops.linear import (
...
from vllm._atom.model_ops.moe import FusedMoE
from vllm._atom.model_ops.quant_v4 import act_quant_inplace
from vllm._atom.model_ops.sparse_attn_v4 import (
    hc_split_sinkhorn,
)
from vllm._atom.model_ops.topK import (
    is_rocm_aiter_fusion_shared_expert_enabled_for_quant_config,
)
from vllm._atom.model_ops.triton_hash_topk import hash_topk_triton
from vllm._atom.model_ops.triton_rmsnorm_nw import rmsnorm_nw
from vllm._atom.model_ops.utils import atom_parameter
from vllm._atom.model_ops.v4_kernels import (
    CompressPlan,
    csa_translate_pack,
    fused_compress_attn,
...
from vllm._atom.utils import envs, mark_spliting_op
from vllm._atom.utils.decorators import support_torch_compile
from vllm._atom.utils.forward_context import AttnState, get_forward_context
...
class MoE(nn.Module):
    ...
    def _gather_ids_for_dp(ids: torch.Tensor, ctx) -> torch.Tensor:
        ...
        if dp_eager_mode:
            from vllm._atom.model_ops.moe import all_gatherv

            sizes = ctx.dp_metadata.get_sizes_across_dp()
            ids_2d = all_gatherv(ids_2d, sizes, get_dp_group())
        else:
            from vllm._atom.model_ops.moe import all_gather_with_padding
