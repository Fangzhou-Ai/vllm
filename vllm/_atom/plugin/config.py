...
def _build_atom_speculative_config_from_vllm(vllm_spec_config: Any):
    ...
    from vllm._atom.config import SpeculativeConfig
...
def _generate_atom_config_from_vllm_config(config: Any) -> PluginConfig:
    from vllm._atom.config import Config, CompilationConfig
...
def _generate_atom_config_from_sglang_config(config: Any):
    ...
    from vllm._atom.config import Config, ParallelConfig, CompilationConfig
...
def generate_atom_config_for_plugin_mode(config: Any = None):
    ...
    atom_config = None
    from vllm._atom.plugin import is_vllm, is_sglang
    from vllm._atom.config import set_current_atom_config
