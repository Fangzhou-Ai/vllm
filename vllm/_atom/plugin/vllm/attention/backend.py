...
class AiterMhaBackendForVllm:
    ...
    def get_builder_cls() -> Type:
        from vllm._atom.plugin.vllm.attention.metadata import AiterMhaMetadataBuilderForVllm

        return AiterMhaMetadataBuilderForVllm

    @staticmethod
    def get_impl_cls():
        from vllm._atom.plugin.vllm.attention.layer import AttentionForVllmMHA
...
class AiterMlaBackendForVllm:
    ...
    @staticmethod
    def get_builder_cls() -> Type:
        from vllm._atom.plugin.vllm.attention.metadata import AiterMlaMetadataBuilderForVllm

        return AiterMlaMetadataBuilderForVllm

    @staticmethod
    def get_impl_cls():
        from vllm._atom.plugin.vllm.attention.layer import AttentionForVllmMLA
...
class AiterSparseMlaBackendForVllm(AiterMlaBackendForVllm):
    ...
    @staticmethod
    def get_builder_cls() -> Type:
        from vllm._atom.plugin.vllm.attention.metadata import AiterMlaSparseMetadataBuilder
...
class AiterSparseMlaIndexerBackendForVllm(AiterMlaBackendForVllm):
    ...
    @staticmethod
    def get_builder_cls() -> Type:
        from vllm._atom.plugin.vllm.attention.metadata import (
