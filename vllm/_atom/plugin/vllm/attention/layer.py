...
from vllm._atom.plugin.vllm.attention.layer_mha import AttentionForVllmMHA
from vllm._atom.plugin.vllm.attention.layer_mla import (
    AttentionForVllmMLA,
    AttentionForVllmSparseMLA,
)
from vllm._atom.plugin.vllm.attention import ops as _atom_vllm_attention_ops  # noqa: F401
