...
class _V4DecodeMetaBuffers:
    ...
    def __init__(
        ...
        *,
        ...
        from vllm._atom.model_ops.v4_kernels.compress_plan import (  # noqa: F401
...
def _infer_atom_attn_state(common_attn_metadata):
    from vllm._atom.utils.forward_context import AttnState
...
def _make_compress_plans(
    ...
    from vllm._atom.model_ops.v4_kernels import make_compress_plans
    from vllm._atom.utils import CpuGpuBuffer
...
def build_atom_v4_attention_metadata(
    ...
    *,
    ...
    """
    from vllm._atom.utils.forward_context import AttentionMetaData
...
def _make_decode_compress_plans(extend_lens_cpu, context_lens_cpu, bufs):
    ...
    from vllm._atom.model_ops.v4_kernels.compress_plan import make_compress_plans
...
def _populate_decode_persistent(
    ...
    from vllm._atom.plugin.vllm.deepseek_v4_ops import write_v4_decode_hca_compress_tail
...
def _populate_prefill(md, common, batch_np, pos_np, q_np, positions_gpu):
    ...
    from vllm._atom.model_ops.v4_kernels import write_v4_paged_prefill_indices
...
def _populate_decode(md, common, batch_np, pos_np, positions_gpu):
    ...
    from vllm._atom.model_ops.v4_kernels import write_v4_paged_decode_indices

    from vllm._atom.plugin.vllm.deepseek_v4_ops import (
        write_v4_decode_hca_compress_tail,
    )
