...
import vllm._atom as atom  # noqa: F401
from vllm._atom.plugin.config import (
...
# Pruned to the DeepSeek-V4 family for the vLLM port (other ATOM models removed).
_ATOM_MODEL_CLASSES: dict[str, str] = {
    "DeepseekV3ForCausalLM": "vllm._atom.models.deepseek_v2:DeepseekV3ForCausalLM",
    "DeepseekV32ForCausalLM": "vllm._atom.models.deepseek_v2:DeepseekV3ForCausalLM",
    "GlmMoeDsaForCausalLM": "vllm._atom.models.deepseek_v2:GlmMoeDsaForCausalLM",
    "DeepSeekMTPModel": "vllm._atom.models.deepseek_mtp:DeepSeekMTP",
    "DeepseekV4ForCausalLM": "vllm._atom.plugin.vllm.models.deepseek_v4:DeepseekV4ForCausalLM",
}
...
def _prepare_env(atom_config) -> None:
    from vllm._atom.plugin.register import set_attn_cls, init_aiter_dist
...
class ATOMModelBase(nn.Module, VllmModel, SupportsQuant, SupportsPP):
    ...
    def __init__(self, *, vllm_config: VllmConfig, prefix: str = ""):
        super().__init__()
        from vllm._atom.config import get_current_atom_config, use_custom_atom_config
        ...
        if self._is_deepseek_v4:
            from vllm._atom.plugin.vllm.deepseek_v4_bridge import (
    ...
    def _register_indexer_caches_with_vllm(self):
        ...
        """
        from vllm._atom.models.deepseek_v2 import DeepseekV32IndexerCache
    ...
    def load_weights(
        ...
        from vllm._atom.model_loader.loader import load_model_in_plugin_mode
