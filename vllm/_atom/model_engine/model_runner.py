...
from vllm._atom.config import Config, set_current_atom_config
from vllm._atom.model_engine.scheduler import ScheduledBatch, ScheduledBatchOutput
from vllm._atom.model_engine.sequence import Sequence, SequenceStatus, SequenceType
from vllm._atom.model_loader.loader import load_model
from vllm._atom.model_ops.rejection_sampler import RejectionSampler
from vllm._atom.model_ops.sampler import SAMPLER_EPS, Sampler
from vllm._atom.spec_decode.eagle import EagleProposer
from vllm._atom.utils import (
    CpuGpuBuffer,
    envs,
    get_hf_text_config,
    init_exit_handler,
...
from vllm._atom.kv_transfer.disaggregation import KVConnectorOutput
from vllm._atom.utils.forward_context import get_kvconnector
from vllm._atom.utils.tbo import (
    UBatchWrapper,
    local_tbo_precompute,
    maybe_create_ubatch_slices,
    sync_dp_for_tbo,
)
from vllm._atom.utils.forward_context import (
    Context,
    DPMetadata,
    ForwardMode,
    get_forward_context,
...
from vllm._atom.utils.selector import get_attn_backend
from torch.profiler import record_function

logger = logging.getLogger("atom")

support_model_arch_dict = {
    "Qwen3ForCausalLM": "vllm._atom.models.qwen3.Qwen3ForCausalLM",
    "Qwen3MoeForCausalLM": "vllm._atom.models.qwen3_moe.Qwen3MoeForCausalLM",
    "LlamaForCausalLM": "vllm._atom.models.llama.LlamaForCausalLM",
    "MixtralForCausalLM": "vllm._atom.models.mixtral.MixtralForCausalLM",
    "DeepseekV3ForCausalLM": "vllm._atom.models.deepseek_v2.DeepseekV2ForCausalLM",
    "DeepseekV32ForCausalLM": "vllm._atom.models.deepseek_v2.DeepseekV2ForCausalLM",
    "DeepseekV4ForCausalLM": "vllm._atom.models.deepseek_v4.DeepseekV4ForCausalLM",
    "GptOssForCausalLM": "vllm._atom.models.gpt_oss.GptOssForCausalLM",
    "GlmMoeDsaForCausalLM": "vllm._atom.models.deepseek_v2.GlmMoeDsaForCausalLM",
    "Glm4MoeForCausalLM": "vllm._atom.models.glm4_moe.Glm4MoeForCausalLM",
    "Qwen3NextForCausalLM": "vllm._atom.models.qwen3_next.Qwen3NextForCausalLM",
    "Qwen3_5ForConditionalGeneration": "vllm._atom.models.qwen3_5.Qwen3_5MultimodalModel",
    "Qwen3_5MoeForConditionalGeneration": "vllm._atom.models.qwen3_5.Qwen3_5MoeMultimodalModel",
    "KimiK25ForConditionalGeneration": "vllm._atom.models.kimi_k25.KimiK25ForCausalLM",
    "MiniMaxM2ForCausalLM": "vllm._atom.models.minimax_m2.MiniMaxM2ForCausalLM",
    "MiMoV2ForCausalLM": "vllm._atom.models.mimo_v2.MiMoV2ForCausalLM",
    "MiMoV2FlashForCausalLM": "vllm._atom.models.mimo_v2.MiMoV2ForCausalLM",
}
# seed = 34567
# np.random.seed(seed)
...
class ModelRunner:
    ...
    def __init__(self, rank: int, config: Config):
        ...
        from vllm._atom.utils.graph_marker import set_graph_marker_enabled
        ...
        from vllm._atom.utils.debug_helper import (
        ...
        if self.config.speculative_config and get_pp_group().is_last_rank:
            from vllm._atom.utils.backends import set_model_tag
        ...
        if self.attn_metadata_builder.compute_per_req_cache_bytes() > 0:
            from vllm._atom.model_engine.llm_engine import (
