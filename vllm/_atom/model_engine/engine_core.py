...
import torch
import zmq
from vllm._atom.config import Config, ParallelConfig
from vllm._atom.model_engine.async_proc import AsyncIOProcManager
from vllm._atom.model_engine.engine_utility import EngineUtilityHandler
from vllm._atom.model_engine.scheduler import Scheduler
from vllm._atom.model_engine.sequence import Sequence, SequenceStatus, get_exit_sequence
from vllm._atom.utils import envs, init_exit_handler, make_zmq_socket
from vllm._atom.utils.distributed.utils import (
    stateless_destroy_torch_distributed_process_group,
)

from vllm._atom.kv_transfer.disaggregation import KVOutputAggregator
...
class DPEngineCoreProc(EngineCore):
    def __init__(self, config: Config, input_address: str, output_address: str):
        ...
        if envs.ATOM_ENABLE_PREFILL_DELAYER:
            from vllm._atom.model_engine.prefill_delayer import PrefillDelayer
