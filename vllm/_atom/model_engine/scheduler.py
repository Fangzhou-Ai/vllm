...
from vllm._atom.model_engine.block_manager import BlockManager
from vllm._atom.model_engine.request import RequestOutput
...
class Scheduler:
    ...
    def __init__(self, config: Config):
        ...
        from vllm._atom.distributed.kv_events import (
