...
from vllm._atom.config import CompilationLevel, Config, KVCacheTensor
from vllm._atom.model_loader.loader import load_model
from vllm._atom.utils import CpuGpuBuffer, resolve_obj_by_qualname
...
support_eagle_model_arch_dict = {
    ...
    "DeepseekV4MTPModel": "vllm._atom.models.deepseek_v4_mtp.DeepseekV4MTP",
    "Qwen3NextMTPModel": "vllm._atom.models.qwen3_next_mtp.Qwen3NextMTP",
    "MiMoV2MTPModel": "vllm._atom.models.mimo_v2_mtp.MiMoV2MTP",
    "MiMoV2FlashMTPModel": "vllm._atom.models.mimo_v2_mtp.MiMoV2MTP",
    "Qwen3_5MTPModel": "vllm._atom.models.qwen3_5_mtp.Qwen3_5MTP",
    "Eagle3LlamaModel": "vllm._atom.models.eagle3_llama.Eagle3LlamaModel",
    "Eagle3DeepseekMLAModel": "vllm._atom.models.eagle3_deepseek_mla.Eagle3DeepseekMLAModel",
}
