...
from vllm.models.deepseek_v4.amd.atom.distributed.parallel import get_dp_group, get_tp_group
from aiter.fused_moe import fused_moe
from aiter.jit.utils.chip_info import get_gfx
from aiter.jit.utils.torch_guard import torch_compile_guard
from aiter.ops.flydsl.moe_common import GateMode
from aiter.ops.shuffle import shuffle_weight
try:  # installed aiter renamed moe_shuffle_scale -> shuffle_scale
...
from vllm.models.deepseek_v4.amd.atom.model_ops.utils import set_weight_attrs
from vllm.models.deepseek_v4.amd.atom.model_ops.base_config import QuantizeMethodBase
from vllm.models.deepseek_v4.amd.atom.model_ops.fused_moe.config import (
...
from vllm.models.deepseek_v4.amd.atom.model_ops.fused_moe.modular_kernel import (
    FusedMoEModularKernel,
    FusedMoEPrepareAndFinalize,
)
from vllm.models.deepseek_v4.amd.atom.model_ops.fused_moe.mori_prepare_finalize import MoriPrepareAndFinalize
...
from vllm.models.deepseek_v4.amd.atom.model_ops.topK import rocm_aiter_grouped_topk as grouped_topk
from vllm.models.deepseek_v4.amd.atom.model_ops.topK import rocm_aiter_topk_softmax as fused_topk
...
class FusedMoEMethodBase(QuantizeMethodBase):
    ...
    def _maybe_make_prepare_finalize(
        ...
        from vllm.models.deepseek_v4.amd.atom.distributed.parallel import get_ep_group
        ...
        if moe.use_mori_kernels:
            ...
            from vllm.models.deepseek_v4.amd.atom.utils.tbo.ubatching import tbo_enabled
            ...
            if is_async:
                from vllm.models.deepseek_v4.amd.atom.model_ops.fused_moe.mori_prepare_finalize import (
                    _NUM_TBO_UBATCHES,
                    init_mori_op,
                )
...
class Mxfp4MoEMethod(FusedMoEMethodBase):
    ...
    def process_weights_after_loading(self, layer):
        ...
        if self.use_triton:
            ...
            from vllm.models.deepseek_v4.amd.atom.model_ops.fused_moe_triton import _swizzle_mxfp4
    ...
    def apply(
        ...
        if self.use_triton:
            from vllm.models.deepseek_v4.amd.atom.model_ops.fused_moe_triton import (
...
class CompressedTensorsFp8MoEMethod(FusedMoEMethodBase):
    ...
    def get_fused_moe_quant_config(
        ...
        from vllm.models.deepseek_v4.amd.atom.model_ops.fused_moe.config import fp8_w8a8_moe_quant_config
...
# Write the MoE result into a caller-allocated ``output`` buffer (mutating op)
# rather than returning a fresh tensor. Under vLLM's ROCm cudagraph, the whole
# model forward is Inductor-compiled and then cudagraph-captured; ``cudagraphify``
# only manages the compiled graph's own I/O/intermediate buffers, so an opaque
# custom op that RETURNS a freshly-allocated tensor leaves that tensor
# unmanaged — its capture-time address is reused on replay while the surrounding
# graph expects fresh data, giving correct eager output but garbage under
# graphs. Declaring ``mutates_args=["output"]`` makes Inductor manage ``output``
# as a graph-static buffer that the op writes into (the vLLM-op convention),
# which is cudagraph-replay-safe. (The attention op returns fresh yet works only
# because it gets vLLM's special attention-cudagraph handling, which the MoE, a
# plain op, does not.)
direct_register_custom_op(
    op_name="moe_forward",
    op_func=moe_forward,
...
class FusedMoE(torch.nn.Module):
    ...
    def forward_impl_graph(
        ...
        if use_dp_gather_scatter:
            ...
            from vllm.models.deepseek_v4.amd.atom.utils.tbo.ubatching import tbo_active

            _tbo = tbo_active()
            if _tbo:
                from vllm.models.deepseek_v4.amd.atom.utils.tbo.ubatching import (
...
# Vendored-port equivalent of FusedMoEDecoratorForPluginMode: rename so
# vLLM's FusedMoE-name-based module introspection never matches this class.
FusedMoE.__name__ = "ATOMFusedMoE"
FusedMoE.__qualname__ = "ATOMFusedMoE"
